				...
				<div class="box">
					<div class="content">
						<div class="form loginBox">
							...
							<input class="form-control" type="text" placeholder="Email" name="lg_uname"/>
							<input class="form-control" type="password" placeholder="Password" name="lg_password" readonly onfocus="this.removeAttribute('readonly');"/>
